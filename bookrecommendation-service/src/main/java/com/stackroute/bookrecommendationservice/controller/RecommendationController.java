...
public class RecommendationController {
    ...
    public ResponseEntity<String> checkIfFavourite(@RequestParam(value="emailId") String emailId, @RequestParam(value = "bookTitle") String bookTitle){
        //String message = recommendationService.checkIfFavourite(emailId,bookTitle);
...
//    @GetMapping("/test")
//    public ResponseEntity<List<Book>> test(@RequestParam(value = "bookTitle") String bookTitle){
//        //return new ResponseEntity<List<Book>>(this.bookRepository.findBooksByB(bookTitle),HttpStatus.OK);
//    }
