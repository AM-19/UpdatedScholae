...
export class ReadBookComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.recommendationService.checkIfUserIsReadingBook("AnubhavMishra@kidsjoyment.com", this.bookTitle)
    this.recommendationService.checkIfUserIsReadingBook(sessionStorage.getItem("userName"), this.bookTitle)
      .subscribe(data => {
        ...
        if (data === "User is reading book") {
          ...
          // this.recommendationService.returnUserProgress("AnubhavMishra@kidsjoyment.com", this.bookTitle)
    ...
    // this.recommendationService.checkIfUserCompletedBook("AnubhavMishra@kidsjoyment.com", this.bookTitle)
  ...
  backToDashboard() {
    ...
    this.recommendationService.saveUserProgress(sessionStorage.getItem("userName"), this.bookTitle, this.pageVariable)
      // this.recommendationService.saveUserProgress("AnubhavMishra@kidsjoyment.com", this.bookTitle, this.pageVariable)
      .subscribe(data => {
